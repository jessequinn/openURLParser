...
class openURLParser {
	...
	private $replace = array( array("and", "%26"),array("(", "%28"),array(")", "%29"),array(",", "%2C"), array(" ", "%20"), array("é", "%C3%A9"), array("ü", "%C3%BC"), array("#", "%23"), array("%", "%25"), array("&", "%63"), array("+", "%2B"), array("/", "%2F"), array("<", "%3C"), array("=", "3D"), array(">", "%3E"), array("?", "%3F"), array(":", "%3A"));
	
	//Array of all data 
	private $metaDataObjects = array('rft.atitle=','rft.jtitle=','rft.date=','rft.aufirst=','rft.aulast=','rft.au=','rft.genre=', 'rft_id=');
